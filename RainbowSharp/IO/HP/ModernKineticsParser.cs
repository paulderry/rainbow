...
{
    internal class ModernKineticsParser : I8453Parser
    {
        ...
        public ModernKineticsParser(HP8453Reader reader) {
            this.reader = reader;
        ...
        public string CSV
        {
            get
            {
                ...
                foreach (Spectrum spectrum in spectra)
                {
                    ...
                    double sampleName = spectrum.DoubleParameters.GetValueOrDefault("RelTime");
